...
output "resource_share_id" {
  ...
  description = "ARN of the AWS Resource Access Manager share created for the AWS Migration Hub Refactor Spaces environment."
}

output "resource_share_prinicpals" {
  value       = var.shared_to_principals
  description = "List of AWS principals associated by terraform for the AWS Resource Access Manager share."
}