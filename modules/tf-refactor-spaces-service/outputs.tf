...
output "routes" {
  description = "A collection of the AWS Migration Hub Refactor Spaces route resource attributes. Full output of [`awscc_refactorspaces_service`](https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/refactorspaces_route)"
