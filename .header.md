...
The following elements shown in the diagram are not deployed by the solution but are provided as [inputs](#inputs) and depicted to illustrate a real-world deployment scenario:
...
** An Amazon EC2 instance to host the monolithic application Unistore legacy.
