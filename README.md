...
│
│   with module.refactor_spaces_application["XXXX"].awscc_refactorspaces_application.this,
│   on modules\tf-refactor-spaces-application\main.tf line 13, in resource "awscc_refactorspaces_application" "this":
│   13: resource "awscc_refactorspaces_application" "this" {
│
...
| Application Load Balancer                       | refactor-spaces:application-id | Refactor Spaces Application Id   |
...
For resources managed by the `awscc` provider you must add the tags to the resource definitions or use the . A [feature request](https://github.com/hashicorp/terraform-provider-awscc/issues/800) has been opened to add this feature to the `awscc` provider in the future.
...
| Name | Version |
|------|---------|
| <a name="provider_awscc"></a> [awscc](#provider\_awscc) | >= 0.35.0 |
